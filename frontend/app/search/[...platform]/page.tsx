...
const page = ({ params }: { params: any }) => {
  ...
  return (
    <>
      <nav className="w-full px-5 gap-2 bg-white flex items-center justify-between py-1 border-b border-[#F5F5F5] shadow-lg fixed top-0 right-0 z-50 overflow-x-auto">
        ...
        <div className="flex items-center gap-2 w-max">
          <div className="flex items-center justify-end p-2">
            <Popover>
              <PopoverTrigger>
                <div className="p-2 font-bold px-4 rounded-md bg-black text-white flex items-center justify-center">
                  Try Pro
                </div>
              </PopoverTrigger>
      ...
      <div className="w-full mt-16 h-full flex flex-col p-10 gap-[2rem] justify-start items-center overflow-auto bg-white">
        <div className="flex flex-col w-full h-full items-center justify-start gap-10">
          <div className="w-full px-1 flex items-center justify-start">
            <div className="text-xl font-semibold w-full text-black tracking-tight flex items-center justify-between">
              ...
              >
                <SelectTrigger className="max-w-max h-12">
