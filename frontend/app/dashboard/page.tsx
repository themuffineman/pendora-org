  ...
  return (
    <>
      ...
      <form className='relative w-full flex justify-center items-center'>
          <input className='w-[50%] h-14 p-2 px-[35px] bg-[#F5F5F5] placeholder:text-black/30 shadow-2xl shadow-[#f1f1f1] rounded-md ' placeholder='Enter website domain e.g. domain.com' type="search" />
