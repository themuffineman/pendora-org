...
const Search = ({context}: {context: any}) => {
  ...
  return (
    pathCondition? (
        <div className='w-full flex items-center justify-start gap-3 max-w-[700px] '>
            <form onSubmit={(e)=> goToSearch(e)} className='relative w-[70%] min-w-[300px]  max-w-[600px] flex justify-center items-center self-start'>
